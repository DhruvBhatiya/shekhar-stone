    ...
    <Box className={classes.headerContainer}>
          ...
          <Toolbar style={{ display: "flex", justifyContent: "space-between", padding: "0 0px", minHeight: '50px' }}>
            ...
            <Box className="flex  items-center gap-5 ">
              <Typography variant="body2" className="hidden md:block lg:block xl:block">
                <LocationOnIcon className="text-[#b2cb6b]" /> Nimana Road Vill., Mayla Ramganjmandi, Dist. Kota, Rajasthan
              </Typography>
              <Typography variant="body2" className="md:block lg:block xl:block">
                <TextSnippetIcon className="text-[#b2cb6b]" /> <strong>GST:</strong> 08AKHPM6411C1ZG
              </Typography>
              <Typography variant="body2" className="hidden md:block lg:block xl:block">
                <CallIcon className="text-[#b2cb6b]" /> <strong>CALL ON </strong><a className="text-white text-sm" href="tel:+919414191888">+91 9414191888</a>
              </Typography>
            </Box>
      ...
      <Container1200>
        <Box className={`${classes.upperHeader} ${shrink ? classes.shrinkUpper : ""}`}>
          <Box>
            <NavLink to="/">
              <img src={require(`${process.env.REACT_APP_IMAGES_PATH}/logo/logo.png`)} alt="Logo" width={100} title="Shekhar Stone Company" />
            </NavLink>
          </Box>
